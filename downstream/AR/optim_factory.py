...
try:
    ...
    print('Please install older version of timm to use Nadam')
    Nadam = None
try:
    from timm.radam import RAdam
except ImportError:
    print('Please install older version of timm to use RAdam')
    RAdam = None

try:
    from timm.optim import NovoGrad
except ImportError:
    print('Please install older version of timm')
    NovoGrad = None
