...
from .timesformer_encoder import TimesformerVisionTower
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    elif "timesformer" in vision_tower or "streamformer" in vision_tower:
        return TimesformerVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, **kwargs)
