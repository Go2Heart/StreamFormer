...
class VideoClsDataset_sparse(Dataset):
    ...
    def __init__(self, anno_path, prefix='', split=' ', mode='train', clip_len=8,
        ...
        # using subset with 1/10 size, random sampling
        # random_index = random.sample(range(len(self.dataset_samples)), len(self.dataset_samples)//10)
        # self.dataset_samples = [self.dataset_samples[i] for i in random_index]
        # self.label_array = [self.label_array[i] for i in random_index]
