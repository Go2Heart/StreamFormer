...
def build_multi_task_dataset(multitask_datasets, args):
    ...
    for task, dataset in multitask_datasets.items():
        if "SSV2" == task:
            ...
            for mode, mode_info in dataset.items():
                ...
                elif mode == "test" or mode == "validation": # consider as test set for now
            ...
            for mode, mode_info in dataset.items():
                ...
                if mode == "train":
                    ...
                    multi_task_config["Kinetics"]['label2id'] = Kinetics_dataset.label2id
                elif mode == "test" or mode == "validation": # consider as test set for now
            ...
            for mode, mode_info in dataset.items():
                ...
                if mode == "train":
                    ...
                    multi_task_config[task]["label2id"] = task_localization_dataset.label2id
                elif mode == "test" or mode == "validation":
            ...
            for mode, mode_info in dataset.items():
                ...
                if mode == "train":
                    ...
                    multi_task_config[task]["label2id"] = task_refer_vos_dataset.label2id
                elif mode == "test" or mode == "validation":
    ...
    if train_dataset_dict:
        ...
        multitask_train_dataset = MultiTaskDataset(train_dataset_dict, balance_sample_num=True, scale=args.balance_sample_num_scale)
    else:
        multitask_train_dataset = None
    if test_dataset_dict:
        multitask_test_dataset = MultiTaskDataset(test_dataset_dict, balance_sample_num=False)
    else:
...
if __name__ == "__main__":
    ...
    multitask_train_dataset, multitask_test_dataset = build_multi_task_dataset(dataset_metadata, args)
